  ...
  <section className="appointment w-full pt-[12rem] pb-[2rem]">
    <div className="inner1 w-[85%] flex gap-[3rem] my-0 mx-auto pb-[4rem]">
      <div className="aboutLeft relative w-[50%] flex flex-col gap-[2rem]">
        ...
        <p className="text-justify text-[1.1rem] text-[#848e9f]">
        ...
        <div className="buttonsContainer text-white flex gap-[2rem] pt-[2rem] font-[500]">
          <NavLink
            to="/our_doctors"
            className="text-[20px] bg-blue-700"
          >
            Find Doctor
          </NavLink>
      ...
      <div className="aboutRight w-[50%] flex flex-col gap-[2rem]">
        <div className="bg-[#eff5f9] flex flex-col text-center rounded px-[2rem] gap-[2rem] py-[3rem]">
