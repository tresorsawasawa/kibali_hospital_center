...
const DoctorCard = ({
  ...
  <div className="doctorItem h-[400px] w-[80%]  rounded-[8px] bg-[#f1f6f8] mt-0 mx-auto mb-4rem">
    <div className="teamItem flex gap-[1.5rem] w-full h-full ">
      <div className="leftCont w-[40%] relative">
        <img
          src={avatar}
          alt={name}
          className="object-cover left-0 absolute w-full h-full imgBorderRadius"
        />
      </div>
